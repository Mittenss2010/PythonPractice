...
if __name__ == "__main__":
    ...
    # dataPath = 'G:/cqsy_collection/alldata-notcomplete/tmp/'
    # dataPath = 'J:/【0 标注数据】/数据集版本管理/20190808_datasets-mix base + test/tmp/'
    # dataPath = 'H:/【0 标注数据】/数据集版本管理/Mix_base_test_40656/tmp/'
    dataPath = 'F:/数据集版本管理/20190914_datasets/tmp/'
